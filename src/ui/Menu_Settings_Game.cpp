...
void Menu_Settings_Game::performSelectAction(Daedalus::GameState::MenuItemHandle item)
{
...
bool Menu_Settings_Game::onInputAction(Engine::ActionType action)
{
...
void Menu_Settings_Game::onCustomAction(const std::string& action)
{
